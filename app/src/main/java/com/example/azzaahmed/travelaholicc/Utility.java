...
//public static String URL_TRAVELPAYOUTS_FLIGHT_REQ_CHEAP = "http://api.travelpayouts.com/v1/prices/calendar?";
    ...
    public static String setUrlTravelpayoutsFlightReqCheap_NoClassType(String origin,String destination,String depart_date,String return_date,String currency) {
        URL_TRAVELPAYOUTS_FLIGHT_REQ_CHEAP = URL_TRAVELPAYOUTS_FLIGHT_REQ_CHEAP+"origin="+origin+"&destination="+destination+"&depart_date="+depart_date+"&return_date="+return_date+"&currency="+currency+"&page=1&limit=10&sorting=price&token="+TRAVELPAYOUTS_TOKEN_FLIGHT;
        return URL_TRAVELPAYOUTS_FLIGHT_REQ_CHEAP;
    }
    public static String setUrlTravelpayoutsFlightReqCheap_Month(String origin,String destination,String depart_date,String return_date,String currency) {
        URL_TRAVELPAYOUTS_FLIGHT_REQ_CHEAP = URL_TRAVELPAYOUTS_FLIGHT_REQ_CHEAP+"origin="+origin+"&destination="+destination+"&depart_date="+depart_date+"&return_date="+return_date+"&currency="+currency+"&calendar_type=departure_date"+"&token="+TRAVELPAYOUTS_TOKEN_FLIGHT;
        return URL_TRAVELPAYOUTS_FLIGHT_REQ_CHEAP;
    }
